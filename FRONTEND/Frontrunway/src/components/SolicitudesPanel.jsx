          ...
          <div className="bg-white rounded-lg p-6 w-11/12 max-w-2xl max-h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-3">
              <p className="text-gray-700">
                <span className="font-semibold">ID Solicitud:</span>{" "}
              ...
              <p className="text-gray-700">
                <span className="font-semibold">Dirección de recogida:</span>{" "}
                {selectedSolicitud.direccion_recogida}
              </p>
              <p className="text-gray-700">
                <span className="font-semibold">Dirección de entrega:</span>{" "}
                {selectedSolicitud.direccion_entrega}
              </p>
              <p className="text-gray-700">
                <span className="font-semibold">Descripcion entrega:</span>{" "}
                {selectedSolicitud.descripcion}
              </p>
              <p className="text-gray-700">
                <span className="font-semibold">Fecha y Hora:</span>{" "}
                {selectedSolicitud.fecha_hora
                  ? new Date(selectedSolicitud.fecha_hora).toLocaleString(
                      "es-ES",
                      {
                        year: "numeric",
                        month: "2-digit",
                ...
                <input
                  ...
                  value={
                    editFormData?.fecha_hora
                      ? new Date(editFormData.fecha_hora).toLocaleString(
                          "es-ES",
                          {
                            year: "numeric",
                            month: "2-digit",
              ...
              <div>
                ...
                >
                  <option value={editFormData?.id_domiciliario}>
                    {editFormData?.domiciliario_nombre ||
