...
const Header = ({ title = "Panel de Control", title2 = "RunWayDomicilios" }) => {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 bg-gradient-to-r from-slate-600 to-slate-700 shadow-lg z-40">
            ...
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center gap-4">
                <button
                  ...
                  className="p-2 rounded-lg hover:bg-slate-500 transition-colors lg:hidden"
                >
      ...
      <aside className={`
        ...
        bg-gradient-to-b from-slate-700 to-slate-800 shadow-lg
        transform transition-transform duration-300 ease-in-out
        ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}
        z-50 lg:z-30
        flex flex-col
      `}>
        <div className="h-16 flex items-center justify-between px-4 bg-slate-800/50">
          <span 
        ...
        <div className="p-4 border-t border-slate-700">
          <div className="flex items-center gap-3 px-4 py-3">
            ...
            <button 
              onClick={logout}
              className="p-2 rounded-lg hover:bg-blue-600 text-white transition-colors"
              title="Cerrar sesión"
            >
              <FaSignOutAlt className="w-5 h-5" />
            </button>
